package devel0per36.communication.mobile.entity;
 ...
 * Ключевой фишкой этого тарифа является возможность подключения медиасервисов - вместо полной стоимости цена за
...
public class Social extends Online {
    ...
    /**
     * Метод, который форматирует названия Медиасервисов в одну троку
