package devel0per36.communication.mobile.print;

import devel0per36.communication.mobile.util.FindTariffs;
import devel0per36.communication.mobile.util.SortTariffs;
import devel0per36.communication.mobile.entity.Tariff;
import devel0per36.communication.mobile.util.ClientStatistics;
import devel0per36.communication.mobile.util.comparator.CostTariffComparator;
...
public class PrintingInfo {
    ...
    public SortTariffs getSortTariffs() {
        return sortTariffs;
    }
    public void setSortTariffs(SortTariffs sortTariffs) {
        this.sortTariffs = sortTariffs;
    }
}
